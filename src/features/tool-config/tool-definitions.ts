...
// RedInk 的固定提示词模板仍保留在业务代码中，这里只存用户可编辑的补充语句。
  ...
  },
  {
    ...
    fieldOverrides: {
      ...
      text1: {
        ...
        description:
          "只填写你希望额外强调的偏好，系统会自动保留图片理解的 JSON 输出结构，无需填写变量或示例 JSON",
      ...
      text2: {
        ...
        description:
          "只填写你对商品文案语气和重点的补充要求，系统会自动保留文案生成模板，无需填写变量或输出格式",
        userOverridable: true,
      ...
      text3: {
        ...
        description:
          "只填写你对发布草稿风格和侧重点的补充要求，系统会自动保留发布文案模板，无需填写变量或输出格式",
        userOverridable: true,
      ...
      text4: {
        ...
        description:
          "只填写你对发布图氛围和视觉方向的补充要求，系统会自动保留出图模板，无需填写变量或参考文案结构",
        userOverridable: true,
